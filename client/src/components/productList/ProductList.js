  ...
  return (
    <div className="product__container">
      <ul className="product__list">
          ...
          <li className="product__item reveal ">
            <Link to={`/productpage/:productId`} className="">
              <img
                className="product__item-main-image"
                src={mainImage}
                alt="hause"
              />
              <div>
                ...
                <p className="product__item-description">
                  ...
                  Optio, eveniet! Explicabo eos labore placeat tempora sit illum
                  accusamus quae nulla eius magni totam harum, odio omnis iste
                  itaque nisi saepe?
                </p>
              </div>
            </Link>
        ...
        <li className="product__item">
          ...
          <div>
            ...
            <p className="product__item-description">
              ...
              eveniet! Explicabo eos labore placeat tempora sit illum accusamus
              quae nulla eius magni totam harum, odio omnis iste itaque nisi
              saepe?
            </p>
          </div>
        </li>
